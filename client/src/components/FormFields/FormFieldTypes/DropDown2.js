  ...
  return (
    <div>            
        ...
        <br/>
                ...
                {/* <div>                                
                  <input type="textarea"  className="multi-choice add-option"    placeholder="" onKeyDown={handleKeyDown} />                               
                </div> */}
                
               
        
        <input type="textarea" className="multi-choice" placeholder='Enter option ' />
        <br/>
