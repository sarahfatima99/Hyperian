...
lg:mx-0
  px-8 py-3 rounded bg-green-300 font-bold text-gray-800 hocus:bg-green-400 hocus:text-gray-900 
  border-b-0
`;
...
export default ({ roundedHeaderButton = false, logoLink, links, className, collapseBreakpointClass = "lg" }) => {
  ...
  const defaultLinks = [
    <NavLinks key={1}>
      ...
      {/* <NavLink href="/AccountBox" tw="lg:ml-12!">
        Login
      </NavLink> */}
      {/* <NavLink href="/AccountBox" tw="lg:ml-12!">
        Login
  ...
  const defaultLogoLink = (
    <LogoLink href="/">
      <img src="https://scalebranding.com/wp-content/uploads/2020/11/Monogram-Letter-H-Logo.jpg" alt="logo" />
      Hyperion
    </LogoLink>
  );
